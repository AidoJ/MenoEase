-- Update energy_levels table with detailed 0-11 scale
...
-- Note: The "8/10 Wired but Tired" variant can be handled in the UI as a special case
-- when displaying level 8, or we can add it as a separate value if needed
